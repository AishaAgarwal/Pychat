...
def login(client):
	client.send(bytes("Please enter your username: ","utf-8"))
	username = client.recv(1024).decode("utf-8")
	client.send(bytes("Please enter your password: ","utf-8"))
	...
	if username in credentials and credentials[username] == hashed_password:
		...
		credentials[username] = session_key
		client.send(bytes("Login successful! Your session key is: " + session_key,"utf-8"))
		return username
	else:
		client.send(b"Error: Invalid username or password")
		return None 
